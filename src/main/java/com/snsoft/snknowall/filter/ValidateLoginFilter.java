package com.snsoft.snknowall.filter;
...
public class ValidateLoginFilter implements Filter {
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
		...
		if(req.getServletPath().equals("/user") && req.getMethod().equals("GET")) {
			filterChain.doFilter(req, resp);
			return;
		}
		if(req.getServletPath().equals("/manager") && req.getMethod().equals("GET")) {
			filterChain.doFilter(req, resp);
			return;
		}
